...
class Vibevault < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/lunaos-ai/luna-vault/releases/download/v0.1.3/vibevault_0.1.3_darwin_arm64.tar.gz"
  ...
  test do
    assert_match "0.1.3", shell_output("#{bin}/vibevault --version")
  end
end
